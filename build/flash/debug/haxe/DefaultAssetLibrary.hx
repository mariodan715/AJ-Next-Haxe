...
@:keep @:dox(hide) class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		classTypes.set (id, __ASSET__assets_index_html);
		types.set (id, AssetType.TEXT);
		#end
		id = "assets/QuestParchmentPopup_Canvas.js";
		#if html5
		preload.set (id, true);
		#elseif (desktop || cpp || flash)
		classTypes.set (id, __ASSET__assets_questparchmentpopup_canvas_js);
		types.set (id, AssetType.TEXT);
		#end
...
@:keep @:bind #if display private #end class __ASSET__assets_index_html extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_questparchmentpopup_canvas_js extends flash.utils.ByteArray { }


#elseif (desktop || cpp)

@:file("assets/index.html") #if display private #end class __ASSET__assets_index_html extends haxe.io.Bytes {}@:file("assets/QuestParchmentPopup_Canvas.js") #if display private #end class __ASSET__assets_questparchmentpopup_canvas_js extends haxe.io.Bytes {}
