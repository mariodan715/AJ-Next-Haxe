...
@:keep @:bind #if display private #end class __ASSET__assets_index_html extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_questparchmentpopup_canvas_js extends null { }
